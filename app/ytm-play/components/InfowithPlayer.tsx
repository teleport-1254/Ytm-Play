        ...
        <div
            ...
            <div className='position-absolute w-100 h-100 z-0'
                ...
                <img
                    ...
                    style={{
                        WebkitFilter: "blur(70px) brightness(70%)",
                    }} />
            </div>
                    ...
                    <div className="position-relative">
                        {
                            (infoData[4] != undefined) ?
                                <img
                                    ...
                                    className="object-fit-cover img square-img-large"
                                    alt={infoData[2]}
                    ...
                    <div className='ps-3 w-100'>
                        {
                            (infoData[2] != undefined) ?
                                <h3 className="card-title one-line-text-w-100 fluid-text-h3" title={infoData[2]}>{infoData[2]}</h3> :
                                <Skeleton className='card-title w-50 p-2' baseColor='#888' highlightColor='#999' />

                        }
                        {
                            (infoData[3] != undefined) ?
                                <h5 className="card-text one-line-text-w-100 fluid-text-h5 text-body-secondary">{infoData[3]}</h5> :
                                <Skeleton className='card-title w-25 mt-2 p-1' baseColor='#888' highlightColor='#999' />

                        }
                        <div className='p-0 m-0'>
                            <button className="btn p-0" type="button" data-bs-toggle="offcanvas" data-bs-target="#queue-offcanvas" aria-controls="staticBackdrop">
