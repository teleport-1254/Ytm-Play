        ...
        <>
            {
                (name == '') ?
                    ...
                    <div className='position-relative'>
                        <div className='position-absolute z-1 w-100 dark-subtle-top-bottom-gradiant'>
                            <div className='d-flex align-items-center ps-2'>
                                <button className="btn p-0" type="button" onClick={handleBackBtn}>
                        ...
                        <div className='position-relative z-0 w-100'>
                            ...
                            <div className='d-flex justify-content-evenly bg-body'>
                                <button className={tab == 'SONG' ?
                                    "btn w-100 rounded-0 p-2 bg-black fs-5" :
